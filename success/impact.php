...
<head>
	...
	<title>Impact: Venture Community Association</title>
	<meta name="description" content="The wider impact of our work in the community is summarised here.">
	...
	<main class="general" id="maincontent">
		...
		<h2>Impact</h2>
			...
			<div class="inner">
				...
				<p>This year has been fantastic at Venture, here are some of the highlights:</p>

				<ul class="list-item">
					<li>32 local volunteers were recruited contributing 2.880 volunteer hours to the VCA</li>
					<li>6 VCA volunteers have moved from long term unemployment into paid work</li>
					<li>There were over 15,000 attendances at the Notting Hill Adventure Playground</li>
					<li>We launched a new healthy living project called ‘Active Wednesdays’ with affordable fitness classes and a subsidized healthy lunch. Active Wednesday now attracts over 80 local people every week</li>
				</ul>

				<p>Watch this video to learn more about the work that we do:</p>

                <div class="inner video-wrapper">

                    <iframe width="560" height="315" src="https://www.youtube.com/embed/ycanaoGB5co" frameborder="0" allowfullscreen></iframe>
                ...
                <div class="inner video-text">
                    ...
                    <p>Video not working? Please visit <a href="https://www.youtube.com/embed/ycanaoGB5co">YouTube</a> or right click <a href="/video/venture-community-centre.mp4" download>download</a> and select 'save as' or 'download as' to watch on your computer/device. Consider your data allowance before downloading - this file is 18 MB.</p>
